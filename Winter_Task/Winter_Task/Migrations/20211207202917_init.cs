        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialIcon = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Firstame = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TownAndCity = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillingDetails_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Debth = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Weight = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    QualityChecking = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    FreshnessDuration = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    WhenPacking = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BoxContains = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Desrciption = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentProductCommentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ParentProductCommentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingDetails_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComments_ParentProductCommentId",
